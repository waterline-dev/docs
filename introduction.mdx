...
<CardGroup cols={2}>
  ...
  <Card title="Deterministic scoring" icon="calculator">
    The progress percentage comes from consistent thresholds, not a raw LLM output. The same codebase and ticket always produce the same score.
  </Card>
  <Card title="Always current" icon="arrows-rotate">
    Every push to your repo triggers an automatic re-index. The index stays fresh without any manual action.
  </Card>
