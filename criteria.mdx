...
The overall progress percentage is the fraction of SATISFIED criteria. PARTIAL doesn't count — it signals work in progress. See [Progress Score](/how-it-works/progress-score) for the full explanation.
